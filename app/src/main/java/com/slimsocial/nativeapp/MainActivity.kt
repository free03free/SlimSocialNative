...
class MainActivity : Activity() {
    ...
    private fun applyControls() {
        ...
        if (verticalPhotoMode) {
            ...
            js.append("""if(!window.__slimVerticalPhotos){window.__slimVerticalPhotos=true;function __slimIsPhoto(i){if(!i)return false;var r=i.getBoundingClientRect();var src=i.currentSrc||i.src||i.getAttribute('src')||'';return r.width>=60&&r.height>=40&&src.length>20&&!/data:image\//i.test(src);}function __slimVerticalPhotoPass(){var imgs=Array.from(document.images).filter(__slimIsPhoto);var done=[];for(var ii=0;ii<imgs.length;ii++){var img=imgs[ii],node=img.parentElement,group=null,photos=null;for(var d=0;node&&d<10;d++,node=node.parentElement){var ps=Array.from(node.querySelectorAll('img')).filter(__slimIsPhoto);if(ps.length>=2&&ps.length<=20){group=node;photos=ps;break;}}if(!group||done.indexOf(group)!==-1)continue;done.push(group);group.classList.add('slim-vertical-photo-group');group.style.setProperty('display','flex','important');group.style.setProperty('flex-direction','column','important');group.style.setProperty('flex-wrap','nowrap','important');group.style.setProperty('grid-template-columns','1fr','important');group.style.setProperty('grid-template-rows','none','important');group.style.setProperty('width','100%','important');group.style.setProperty('max-width','100%','important');group.style.setProperty('height','auto','important');group.style.setProperty('background','transparent','important');group.style.setProperty('border','0','important');group.style.setProperty('box-shadow','none','important');group.style.setProperty('overflow','visible','important');for(var pi=0;pi<photos.length;pi++){var x=photos[pi],n=x;for(var j=0;j<10&&n&&n!==group;j++){n.style.setProperty('display','block','important');n.style.setProperty('flex','0 0 auto','important');n.style.setProperty('width','100%','important');n.style.setProperty('max-width','100%','important');n.style.setProperty('height','auto','important');n.style.setProperty('min-height','0','important');n.style.setProperty('grid-column','1 / -1','important');n.style.setProperty('grid-row','auto','important');n.style.setProperty('float','none','important');n.style.setProperty('clear','both','important');n.style.setProperty('background','transparent','important');n.style.setProperty('border','0','important');n.style.setProperty('box-shadow','none','important');n.style.setProperty('padding','0','important');n.style.setProperty('overflow','visible','important');if(n.parentElement===group)n.style.setProperty('margin',pi<photos.length-1?'0 0 8px 0':'0','important');n=n.parentElement;}x.classList.add('slim-vertical-photo');x.style.setProperty('display','block','important');x.style.setProperty('visibility','visible','important');x.style.setProperty('opacity','1','important');x.style.setProperty('width','100%','important');x.style.setProperty('max-width','100%','important');x.style.setProperty('height','auto','important');x.style.setProperty('min-height','0','important');x.style.setProperty('object-fit','contain','important');x.style.setProperty('object-position','center center','important');try{x.setAttribute('loading','eager');}catch(e){}}}__slimVerticalPhotoPass();if(!window.__slimVerticalPhotoObserver){window.__slimVerticalPhotoObserver=new MutationObserver(function(){clearTimeout(window.__slimVerticalPhotoTimer);window.__slimVerticalPhotoTimer=setTimeout(__slimVerticalPhotoPass,120);});window.__slimVerticalPhotoObserver.observe(document.body,{childList:true,subtree:true,attributes:true,attributeFilter:['style','class','src','srcset']});}window.addEventListener('load',__slimVerticalPhotoPass);window.addEventListener('resize',__slimVerticalPhotoPass);}""")
